...
<body>
    ...
    <main id="main" class="main">
        ...
        <button onclick="window.location.href='{{ route('create_indicator') }}'" class="btn btn-primary my-2">back
        </button>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="inputEmail"
                                                name="deliverable" placeholder="deliverable" required>
                                            @error('deliverable')
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    <div class="d-flex">
                                                        ...
                                                        <form
                                                            action="{{ route('create_deliverable_delete', $data->id) }}"
                                                            method="POST">
                                                            @method('DELETE')
                                                            @csrf
