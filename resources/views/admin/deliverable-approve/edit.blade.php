        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('deliverable_approve_edit_post', $deliverableTbale->id) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">MoVs</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputEmail" name="MoVs"
                                placeholder="MoVs" value="{{ $deliverableTbale->MoVs }}" >
                        </div>
                    </div>
